            ...
            <main className="bg-second text-first">
                <div className="container-fluid container-md py-5">
                    ...
                    <section className="mb-5">
                        ...
                        <div className="mb-4">
                            <h3 className="fs-5 fw-bold fs-2">1. Come posso tracciare il mio ordine?</h3>
                            <p className="ms-3 text-secondary fs-5">
                        ...
                        <div className="mb-4">
                            <h3 className="fs-5 fw-bold fs-2">2. Posso modificare o annullare un ordine dopo averlo effettuato?</h3>
                            <p className="ms-3 text-secondary fs-5">
                        ...
                        <div className="mb-4">
                            <h3 className="fs-5 fw-bold fs-2">3. Cosa devo fare se il mio account è bloccato o ho dimenticato la password?</h3>
                            <p className="ms-3 text-secondary fs-5">
                    ...
                    <section className="my-5">
                        ...
                        <div className="mb-4">
                            <h3 className="fs-5 fw-bold fs-2">4. Quali sono i tempi e i costi di spedizione?</h3>
                            <p className="ms-3 text-secondary fs-5">
                        ...
                        <div className="mb-4">
                            <h3 className="fs-5 fw-bold fs-2">5. Il mio pacco risulta consegnato ma non l'ho ricevuto. Cosa devo fare?</h3>
                            <p className="ms-3 text-secondary fs-5">
                    ...
                    <section className="my-5">
                        ...
                        <div className="mb-4">
                            <h3 className="fs-5 fw-bold fs-2">6. Quali metodi di pagamento accettate?</h3>
                            <p className="ms-3 text-secondary fs-5">
                        ...
                        <div className="mb-4">
                            <h3 className="fs-5 fw-bold fs-2">7. I miei dati di pagamento sono al sicuro?</h3>
                            <p className="ms-3 text-secondary fs-5">
                    ...
                    <section className="mt-5 mb-3">
                        ...
                        <div className="mb-4">
                            <h3 className="fs-5 fw-bold fs-2">8. Qual è la vostra politica di reso?</h3>
                            <p className="ms-3 text-secondary fs-5">
                        ...
                        <div className="mb-4">
                            <h3 className="fs-5 fw-bold fs-2">9. Quando e come riceverò il rimborso?</h3>
                            <p className="ms-3 text-secondary fs-5">
                        ...
                        <div className="mb-4">
                            <h3 className="fs-5 fw-bold fs-2">10. Cosa succede se ricevo un articolo difettoso o danneggiato?</h3>
                            <p className="ms-3 text-secondary fs-5">
